...
- [Společné úkoly](#společné-úkoly)
  - [Lab L01 -- Seznámení s Hyper-V](#lab-l01----seznámení-s-hyper-v)
    - [Vytvoření prázdné VM](#vytvoření-prázdné-vm)
  - [Lab L02 -- Seznámení s Windows 11](#lab-l02----seznámení-s-windows-11)
...
2.  Ukažte **Rychlá nastavení** (Win+A) a **Oznamovací centrum** (Win+N), které ve
...
5.  Předveďte Computer Management konzoli -- z nabídky Win+X i
...
1.  Hyper-V: Zkontrolujte, že k VM **W11** je připojený prázdný disk
    `flash.vhdx` (viz Lab L01) a jako DVD obraz `D:\LabSources\ISOs\win11.iso`
...
19. Ukažte, že instalace probíhá automaticky a pak ji ukončete.
