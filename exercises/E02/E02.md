...
2.  Zkopírujte `D:\sources\install.wim` do `D:\sources` 
...
5.  Nyní bitovou kopii `Windows 11 Pro` z WIM souboru připojte do
    ...
    a. Vytvořte adresář `C:\Deployment\mount`

    a.  `dism /Mount-Image /ImageFile:"D:\sources\install.wim" /index:6 /MountDir:"D:\Deployment\mount"`
...
6.  Nyní provedeme integraci ovladačů a pak aktualizací (včetně
    ...
    d.  `dism /image:"D:\Deployment\mount" /Add-Package /PackagePath:"D:\sources\sxs\Microsoft-Windows-InternetExplorer-Optional-Package~31bf3856ad364e35~amd64~en-US~.cab""`
...
1.  Pro zachycení bitové kopie stanice spusťte následující příkaz
    ...
    a.  `dism /Capture-Image /ImageFile:"D:\MyNewInstall.wim" /CaptureDir:"C:" /Name:"My Windows 11" /ScratchDir:"D:\" /Compress:fast /Verify /Bootable /CheckIntegrity`
...
2.  Po dokončení zachycování připojte sdílenou složku
    ...
    a.  `net use Z: \\W11\Deployment`
        ...
        -   Při dotazu na uživatelské jméno použijte
              **W11\\root** a heslo **root4Lab**
