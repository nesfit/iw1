...
záložce **Platný přístup** (Effective Access) můžete určit účet, jehož
výsledná oprávnění vás zajímají a systém vám je zobrazí.
...
12. Ověřte pro ostatní účty, že se nemohou dostat k obsahu adresáře
    **Secrets** ani k souboru **denik.txt**:
    ...
    -   Pomocí karty Platný přístup (Effective Access).
...
4.  <a id="Lab06_4"></a> Zatrhněte Sdílet tuto složku (Shared this
    folder) a nastavte:
...
5.  Klikněte pravým na sdílený adresář **Firma** a pak zvolte
    ...
    -   Ve Windows 11 je volba v kontextové nabídce pod *Show more
        options*. Pokud volba chybí, povolte nejprve Soubory offline:
        Ovládací panely -> Centrum synchronizace -> Spravovat soubory
        offline -> Povolit soubory offline a restartujte stanici.
