...
- [**Studentské úkoly**](#studentské-úkoly)
  ...
  - [**Lab LS02 -- Šifrování souborů pomocí EFS a záloha certifikátu**](#lab-ls02----šifrování-souborů-pomocí-efs-a-záloha-certifikátu)
...
11. Importujte certifikát **racert.PFX**, vytvořený dříve pomocí
    nástroje `cipher` (viz [Lab LS04, body 1-4](#lab-ls04----sdílení-všech-šifrovaných-souborů)).
