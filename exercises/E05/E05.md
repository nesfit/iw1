...
# AutomatedLab na stanicích vypíná UAC; Lab 01 a Lab 02 potřebují UAC zapnuté (změna vyžaduje restart)
...
-   **W11-domain** je edice *Windows 11 Education*, protože AppLocker
    (Lab 04) není v edici Pro podporovaný.
...
6.  Konvertujte disky 1 a 2 na dynamické. Klikněte pravým tlačítkem myši
    ...
    -   **Pozn.:** dynamické disky jsou od Windows 11 zastaralé (Microsoft
        doporučuje místo nich **Prostory úložišť**, viz Lab 10). Volba
