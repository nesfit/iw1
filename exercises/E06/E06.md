...
-   Stanice tohoto labu mají jediný adaptér (LAN1) a **nemají přístup na
    ...
    na stanicích C304). Úkolu S03 se týká poznámka níže.
...
> **Další prerekvizity**
>
> Dokončený [**Lab S02**](#lab-s02----vytvoření-vlastního-zobrazení)
>
> Soubor s šablonou **fsaTemplate.xml** (složka **C:\utils**).
>
> Pozn.: stanice labu nemají přístup na internet (viz Lab L00), odeslání
...
8.  Spusťte **Prohlížeč událostí** (Event Viewer) a lokalizujte záznam
    ...
    -   Využit vlastní zobrazení **LastHourPerformanceAlerts** vytvořené
        v [**Lab S02**](#lab-s02----vytvoření-vlastního-zobrazení), jenž zobrazuje události
...
> neprázdným obsahem) ve složce dokumenty uživatele **root** (viz S05).
