...
![center](img/s05-settings-advanced-sharing.png)

</div>
<div>

![center](img/s05-adapter-properties.png)

</div>
</div>

<!-- Snímky z Windows 11 24H2: Nastavení › Síť a internet › Upřesnit nastavení sítě › Upřesnit nastavení sdílení (dříve Ovládací panely › Pokročilé nastavení sdílení); vlastnosti adaptéru (druhý snímek, ncpa.cpl) vypadají stále stejně. -->
...
![center](img/s08-share-tab-unshared.png)

</div>
</div>

<!-- Pro nastavení jednoduchého sdílení je potřeba mít povoleno Používat průvodce sdílením (Doporučeno) v Možnostech Průzkumníka souborů (záložka Zobrazení), jinak bude tlačítko Sdílení… zašedlé. Snímek z Windows 11 24H2 (složka C:\Share před nasdílením). -->
...
![center](img/s10-share-tab-shared.png)

</div>
<div>

![center](img/s10-sharing-wizard.png)

</div>
</div>

<!-- Snímky z Windows 11 24H2: vlevo karta Sdílení po nasdílení průvodcem (Sdíleno, síťová cesta \\W11-1\Share), vpravo průvodce Přístup k síti (Sdílení souborů) s účty Bart, Lisa a Marge; Domácí skupina, kterou nabízel Windows 8, už neexistuje. -->
...
![center](img/s12-share-tab.png)

</div>
<div>

![center](img/s12-advanced-sharing.png)

</div>
<div>

![center](img/s12-share-permissions.png)

</div>
</div>

<!-- Možnost specifikovat název sdílené složky je důležitá pro vytváření skrytých sdílení.
V Mezipaměti se nastavují soubory offline (offline files). Snímky z Windows 11 24H2 (sdílení Share na W11-1: Everyone čtení, homer úplné řízení, marge čtení, skupina simpsons změnit). -->
...
![center w:520](img/s15-compmgmt-shares.png)
...
![center](img/s19-libraries-context-menu.png)

</div>
<div>

![center](img/s19-library-properties.png)

</div>
</div>

<!-- Snímky z Windows 11 24H2 (Průzkumník › Knihovny, nová kontextová nabídka; vlastnosti knihovny Dokumenty s více umístěními). Ve Windows 10/11 není sekce Knihovny ve výchozím nastavení viditelná, musí se povolit: Možnosti složky › Zobrazení › Navigační podokno › Zobrazit knihovny. -->
...
![center](img/s24-sync-center.png)

</div>
<div>

![center](img/s24-offline-files.png)

</div>
</div>

<!-- Snímky z Windows 11 24H2 (Ovládací panely › Centrum synchronizace › Spravovat offline soubory); na Windows 11 Pro jsou soubory offline ve výchozím stavu zakázané, povolení vyžaduje restart. -->
...
![center](img/s25-advanced-sharing.png)

</div>
<div>

![center](img/s25-caching-settings.png)

</div>
</div>

<!-- Dialog Nastavení pro offline režim (tlačítko Mezipaměť v Rozšířených možnostech sdílení); snímky z Windows 11 24H2. -->
...
![center](img/s30-sync-conflicts-menu.png)

</div>
<div>

![center](img/s30-resolve-conflict.png)

</div>
</div>

<!-- Snímky z Windows 11 24H2: konflikt souboru offline.txt ze sdílení \\192.168.0.11\Share (upraven offline na W11-1 i na serveru W11-2), Centrum synchronizace › Zobrazit konflikty synchronizace › Zobrazit možnosti řešení.
...
![center w:430](img/s41-effective-access.png)
...
![center](img/s48-auditing.png)

<!-- Dialog Upřesnit nastavení zabezpečení › Auditování, snímek z Windows 11 24H2 (soubor C:\Share\iw1.txt, položky auditu pro účty homer, bart a lisa). -->
...
![center](img/s50-folder-properties.png)

</div>
<div>

![center](img/s50-advanced-attributes.png)
...
![center](img/s57-gpedit-efs-menu.png)

<!-- Editor místních zásad skupiny (gpedit.msc), snímek z Windows 11 24H2: Konfigurace počítače › Nastavení systému Windows › Nastavení zabezpečení › Zásady veřejných klíčů › Systém souborů EFS › kontextová nabídka. -->
