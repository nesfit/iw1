...
<!-- TODO-SCREENSHOT: snímky 15, 18, 21, 26, 28, 31, 33, 34, 36 – pořídit znovu z Windows 11 25H2 -->
...
- Pro uchování vyžadují souborový systém NTFS (i ReFS)
  - U jiných souborových systémů vytvořeny jen dočasně

<!--
Omezení na NTFS souborový systém je dáno tím, že po výchozí instalaci obsahuje systém pouze jediného poskytovatele pro vytváření stínových kopií, jenž podporuje pouze NTFS (a ReFS). Lze ale dodat i vlastní poskytovatele, jenž mohou pracovat i s jinými souborovými systémy.
...
- Není k dispozici pro účty Microsoft Entra ID / doménové ani lokální účty
...
- Ochrana dat v OneDrive
  - Historie verzí souborů a koš (osobní účet 30 dní, pracovní 93 dní)
...
Doba uchování v koši: 30 dní u osobního OneDrive, 93 dní u OneDrive pro práci nebo školu (SharePoint). Files Restore je u OneDrive pro práci nebo školu i u předplatného Microsoft 365 Personal/Family.
...
<!--
Snímek z Windows 10, ve Windows 11 25H2 je dialog totožný (nástroj se nemění).
-->
...
- Ochrana systému (System Protection)
  ...
  - Využívá stínové kopie (shadow copies)
  - Ovládací panely > Systém > Ochrana systému (`SystemPropertiesProtection.exe`), Nastavení > Systém > Informace > Ochrana systému
...
<!--
Dialog je ve Windows 11 totožný (klasické Vlastnosti systému). U Windows 7 byla navíc možnost zapnout pouze ochranu souborů (a ne celého systému), jenž umožňovala přístup k předchozím verzím souborů, ale neumožňovala obnovit celý systém do předchozího stavu.
-->
...
- Uchování: Windows 11 24H2 od června 2025 nejvýše 60 dní (starší body se mažou); dříve 90 dní
...
Šedesátidenní limit zavedla bezpečnostní aktualizace z 10. 6. 2025 (KB5060842) pro Windows 11 24H2: „After installing the June 2025 Windows security update, Windows 11, version 24H2 will retain system restore points for up to 60 days. … This 60-day limit will also apply to future versions of Windows 11, version 24H2.“ Windows 11 25H2 je balíček povolení nad stejnou platformou 24H2, limit tedy platí i tam.
...
<!--
rstrui.exe – dialog je ve Windows 11 totožný. Tlačítko „Vyhledat ovlivněné programy“ ukáže, které aplikace a ovladače budou odstraněny nebo vráceny.
...
- Nový nástroj Windows 11 24H2/25H2 (2026), Nastavení > Systém > Obnovení > Obnovení k určitému časovému bodu
...
- Obnova pouze z Windows RE: Odstranit potíže > Obnovení k určitému časovému bodu (nutný klíč pro obnovení BitLockeru)
- Výchozí stav
...
<!--
Frekvenci a dobu uchování může měnit jen edice Enterprise (4–72 h), Home a Pro jen zapnutí a limit místa. Nelze exportovat ani připojit body jako obraz; body vytvořené pod jinou edicí (např. před upgradem Home → Pro) nejdou použít; soubory šifrované EFS obnovu blokují.
...
<!--
Historie souborů neumožňuje přístup k verzím souborů, jenž jsou obsaženy v bodech obnovení nebo ve standardních zálohách. Důvodem je, že body obnovení neobsahují žádná uživatelská data, takže je zbytečné k těmto datům přistupovat.
...
- Možnost vyloučit konkrétní knihovny a složky (Vyloučit složky)
...
- Oddíl pro obnovení (GPT typ `DE94BBA4-06D1-4D40-A16A-BFD50179D6AC`, atribut `0x8000000000000001`; MBR id `27`)
  ...
  - Umístit hned za oddíl Windows – Windows ho pak umí zvětšit zmenšením oddílu Windows; formát NTFS
