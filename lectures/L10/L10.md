...
<!--
Dialog je ve Windows 11 totožný (klasické Vlastnosti systému). U Windows 7 byla navíc možnost zapnout pouze ochranu souborů (a ne celého systému), jež umožňovala přístup k předchozím verzím souborů, ale neumožňovala obnovit celý systém do předchozího stavu.
-->
