...
<!-- TODO-SCREENSHOT: snímky 4, 14, 25, 33, 34, 37 – pořídit znovu z Windows 11 25H2 (snímek 5 ukazuje odstraněný Compatibility Monitor, ponechán jako historie – nelze pořídit znovu) -->
...
- Řešení problémů s během starších (desktopových, Win32) programů
...
<!--
Snímek je z Windows 8; ve Windows 11 je dialog stejný, jen s kratším seznamem verzí v režimu kompatibility a s tlačítkem „Změnit nastavení vysokého rozlišení DPI“.
-->
...
- Součást Windows ADK (10.1.26100.2454, prosinec 2024, pro Windows 11 24H2/25H2)
  - 32-bitová verze pro 32-bitové aplikace, 64-bitová pro 64-bitové
...
- **Historie:** App-V (zapouzdření aplikace, streamování ze serveru, běh v izolaci) a MED-V (zapouzdřená aplikace v prostředí Windows XP) z balíku MDOP
  ...
  - MDOP: konec rozšířené podpory 14. 4. 2026; klient App-V ve Windows 11 zůstává v pevné rozšířené podpoře bez dalšího vývoje
...
![center w:520](img/s11-z-stupn-symbol-pro-obsah-14.png)

</div>
</div>

<!--
Snímek je z Windows 8 (hosté Windows Server 2012); rozložení konzoly je ve Windows 11 stejné, panel „Snímky“ se jmenuje „Kontrolní body“.
-->
...
<!--
Windows 11 jako host potřebuje Secure Boot a TPM 2.0, které Hyper-V poskytuje jen v generaci 2 (virtuální TPM je vázán na hostitele – při přesunu VM je třeba klíče exportovat).
...
- Autorizaci (kdo se smí připojit, skupiny, čas) řeší server **NPS** (RADIUS) na Windows Server 2022/2025
...
<!--
Snímky jsou z Windows 8; dialog je ve Windows 11 beze změny dostupný přes ncpa.cpl › Vlastnosti připojení (Nastavení › VPN nabízí jen zjednodušenou podobu).
-->
...
- **Global Secure Access** – Security Service Edge (SSE) Microsoftu, řízený identitou a podmíněným přístupem
  ...
  - Profil provozu Microsoft 365 – kontrola „vyhovující sítě“ v podmíněném přístupu
...
- **Historie**
  - Aplikace Vzdálená plocha z Microsoft Store – konec podpory 27. 5. 2025
...
![center w:760](img/s25-z-stupn-symbol-pro-obsah-14.png)

<!--
Snímek Editoru místních zásad skupiny je z Windows 8; cesta i tři nastavení (metoda ověřování, povolit připojení přes bránu, adresa serveru) jsou ve Windows 11 stejné.
-->
...
<!--
Snímky dialogu Připojení ke vzdálené ploše jsou z Windows 8; ve Windows 11 je mstsc beze změny.
-->
...
- Pro připojení k bráně se používá HTTPS zapouzdřující RDP
...
- Funkce je zastaralá a nezabezpečená (PPTP) – dnes jen k demonstraci
...
<!--
Snímek průvodce je z Windows 8; průvodce ve Windows 11 vypadá shodně.
-->
